...
// осознанных ограничений (8-битный int + узкоспециальный 16-битный
// long только для индексов/счётчиков, только глобальные переменные,
// функции без рекурсии, poke/peek только по константным адресам - всё
// это следствие реальных возможностей этого CPU, не произвольные
// упрощения).
//
