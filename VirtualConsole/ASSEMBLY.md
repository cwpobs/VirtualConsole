...
| Адрес | Регистр | Чтение | Запись |
|-------|---------|--------|--------|
| 0xF0000FEB | MILLIS_LOW | Младший байт прошедших мс | Сбрасывает часы (обнуляет прошедшее время) |
| 0xF0000FEC | MILLIS_HIGH | Старший байт прошедших мс | Сбрасывает часы |
...
Пример - ждать ровно 60 кадров в секунду (~16.7 мс на кадр):
    ...
    LDI A, 0
    STA 0xF0000FEB      ; сброс часов

wait_frame:

    LDA 0xF0000FEC      ; MILLIS_HIGH - страховка на случай >255 мс
    LDI B, 0
    CMP B
    JNZ frame_done

    LDA 0xF0000FEB      ; MILLIS_LOW
    LDI B, 17
    CMP B
    JC wait_frame
...
Адреса: `0xF0000FDE` (X_LOW) - `0xF0000FEA` (STATUS).
